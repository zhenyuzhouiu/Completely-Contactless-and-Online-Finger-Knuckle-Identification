...
\begin{table}[ht!]
    ...
    \begin{tabular}{c c c c c c c}
        ...
        EfficientNetV2-S \cite{tan2021efficientnetv2} & 20.18M &300x300 &classes & 5.40B &  & \\
        EfficientNetV2-S-STTL & 20.00M &300x300 & 9x9 & 5.38B &  &  \\
        EfficientNetV2-S-TRTL &20.00M &300x300 & 9x9& 5.38B &  & \\
        FKNet \cite{cheng2020deep} &7.28M &96x64 &classes & 0.28B &   &  \\
        RFNet-STTL \cite{liu2020contactless} & 0.46M &128x128 &32x32 & 1.39B & 0.0062s & 0.049s \\
        RFNet-TRTL & 0.46M &128x128 &32x32 & 1.39B & 0.0062s & \\
        \hline
    \end{tabular}
    \caption{Comparison time and space complexity of different neural network. Time complexity is the average time of 10k images on the Ubuntu 22.04 with GeForce RTX 2080 GPU. When the template size is classes, it means the training set classes number.}
