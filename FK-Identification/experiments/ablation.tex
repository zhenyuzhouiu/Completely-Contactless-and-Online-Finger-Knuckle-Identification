...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        ...
        \caption{}
    \end{subfigure}
    \caption{Comparative ROC (a) and corresponding CMC (b) for two-session of the Finger Knuckle Database (Version 3.0) \cite{fingerknuckledbv3.0}. For approving our RSIL loss function efficiency, we change the translation parameter and rotation parameter to show the different matching performance.}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        ...
        \caption{}
    \end{subfigure}
    \caption{Genuine matching score distribution (a) and Imposter matching score (b) for two-session of the Finger Knuckle Database (Version 3.0) \cite{fingerknuckledbv3.0}. For approving our RSIL loss function efficiency, we change the translation parameter and rotation parameter to show the different matching performance.}
