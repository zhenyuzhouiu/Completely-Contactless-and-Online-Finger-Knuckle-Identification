...
\begin{table}[ht!]
    ...
    \begin{tabular}{c c c c c c c}
        ...
        \hline
        DeConvRFNet-STTL & 0.36M &128x128 &32x32 &1.29B  &0.03152536s  & 0.013198484s \\
        DeConvRFNet-TRTL & 0.36M &128x128 &32x32 &1.29B  &0.02608954s  & 0.025164932s\\
        EfficientNetV2-S \cite{tan2021efficientnetv2} & 20.18M &300x300 &$1*N$ & 5.40B &0.125654s &0.00002018s \\
        EfficientNetV2-S-STTL & 20.00M &300x300 & 9x9 & 5.38B &0.06760428  & 0.009111184 \\
        EfficientNetV2-S-TRTL &20.00M &300x300 & 9x9& 5.38B &0.07509322s  & 0.02580742s \\
        FKNet \cite{cheng2020deep} &7.28M &96x64 &$1*N$ & 0.28B & 4.644924s &0.055s  \\
        RFNet-STTL \cite{liu2020contactless} & 0.46M &128x128 &32x32 & 1.39B & 0.020719s & 0.011043812s \\
        RFNet-TRTL & 0.46M &128x128 &32x32 & 1.39B & 0.01841888 & 0.019840056s \\
        \hline
    \end{tabular}
    \caption{Comparison time and space complexity of different neural network. Time complexity is the average time on the Ubuntu 22.04 with GeForce RTX 2080 GPU and I7-7800X CPU. When the template size is $1*N$, it means the training set classes number. For the STTL, the shift size is 4; for the TRTL, the shift size is 4, and add rotation with 4 angles.}
